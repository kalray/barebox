...
typedef void __noreturn (*k1c_entry)(unsigned long, void *);

static int do_boot_entry(struct image_data *data, k1c_entry entry,
			 void *fdt_load_addr)
{
...
late_initcall(k1c_register_image_handler);
