...
#define  SDHCI_BUF_RD_READY				BIT(5)
#define  SDHCI_BUF_WR_READY				BIT(4)
...
#define SDHCI_DATA_CRC_ERR              BIT(5)
#define SDHCI_DATA_END_BIT_ERR          BIT(6)
#define SDHCI_INT_ENABLE					0x34
#define SDHCI_ERROR_INT_STAT_EN					0x36
#define SDHCI_SIGNAL_ENABLE					0x38
#define SDHCI_ERROR_INT_SIGNAL_EN           0x3a
