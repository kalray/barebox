...
#define  SDHCI_DMA_SEL_FIELD			GENMASK(4, 3)
...
#define  SDHCI_CMD_TOUT_ERR			BIT(0)
#define  SDHCI_DATA_TOUT_ERR			BIT(4)
...
#define  SDHCI_ADDRESSING			BIT(13)
#define SDHCI_CAPABILITIES					0x40
#define  SDHCI_SDMA_SUPPORT                     BIT(22)
#define SDHCI_CAPABILITIES_1					0x42
#define  SDHCI_SYS_ADDR_64_V4			BIT(27)
